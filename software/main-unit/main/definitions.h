...
// --- Hardware pin map + per-revision drivers ---
// All pins and the buzzer/nav-input drivers live behind the board HAL. Select
// the revision with menuconfig (Netscore board revision). See boards/board.h.
#include "boards/board.h"

// Board-agnostic LEDC allocation for the status LED (GPIO45 on every rev).
// The v2.0 buzzer uses LEDC channels 2-5 (see boards/v20/pins.h); v3.0's
// buzzer uses SDM+GPTimer and leaves LEDC free — no collision either way.
