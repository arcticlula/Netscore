...
#define SEGMENT_CONFIG_1 1
#define SEGMENT_CONFIG_2 2

#define ACTIVE_SEGMENT_CONFIG SEGMENT_CONFIG_2

#if ACTIVE_SEGMENT_CONFIG == SEGMENT_CONFIG_1
// Red with small green, Green with small red
#define SEGMENT_A_VALUES {BIG_RED, BIG_RED, SMALL_GREEN, SMALL_GREEN, BIG_RED, BIG_RED}
#define SEGMENT_B_VALUES {BIG_PURE_GREEN, BIG_PURE_GREEN, SMALL_RED, SMALL_RED, BIG_PURE_GREEN, BIG_PURE_GREEN}
#elif ACTIVE_SEGMENT_CONFIG == SEGMENT_CONFIG_2
// Red split with Green, Green split with Red
#define SEGMENT_A_VALUES {BIG_RED, BIG_RED, SMALL_RED, SMALL_GREEN, BIG_PURE_GREEN, BIG_PURE_GREEN}
#define SEGMENT_B_VALUES {BIG_PURE_GREEN, BIG_PURE_GREEN, SMALL_GREEN, SMALL_RED, BIG_RED, BIG_RED}
#endif