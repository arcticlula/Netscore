...
uint8_t mac_address[] = {0x9c, 0x13, 0x9e, 0xf1, 0x2f, 0x86};
...
void init_esp_now() {
  ...
  ESP_LOGI(TAG, "ESP-NOW Init: WiFi started, Channel 1, PS NONE");
  ...
  peerInfo.channel = 1;          // Ensure this matches the WiFi channel
