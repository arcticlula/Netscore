...
void handle_button_event(int device_id_in, int event_id) {
  last_interaction_time = esp_timer_get_time();
  const button_event_t button_event = (button_event_t)event_id;
  device_t device_id = (device_t)device_id_in;
