...
gpio_num_t mux_1_1_pin, mux_1_2_pin, mux_1_3_pin;
gpio_num_t mux_2_1_pin, mux_2_2_pin, mux_2_3_pin;

volatile gpio_num_t mux_1_sel_pin, mux_2_sel_pin;
...
static inline void turn_mux() { 
  gpio_set_level(mux_1_1_pin, LOW);
  gpio_set_level(mux_1_2_pin, LOW);
  gpio_set_level(mux_1_3_pin, LOW);
  gpio_set_level(mux_2_1_pin, LOW);
  gpio_set_level(mux_2_2_pin, LOW);
  gpio_set_level(mux_2_3_pin, LOW);

  gpio_set_level(mux_1_sel_pin, HIGH);
  gpio_set_level(mux_2_sel_pin, HIGH);
}
...
{
  mux_1_1_pin = (gpio_num_t)mux_1;
  gpio_reset_pin(mux_1_1_pin);  // Reset pin (optional)
  gpio_set_direction(mux_1_1_pin, GPIO_MODE_OUTPUT);
  mux_1_2_pin = (gpio_num_t)mux_2;
  gpio_set_direction(mux_1_2_pin, GPIO_MODE_OUTPUT);
  mux_1_3_pin = (gpio_num_t)mux_3;
  gpio_set_direction(mux_1_3_pin, GPIO_MODE_OUTPUT);
}
void Tlc5940::initMux2(int mux_1, int mux_2, int mux_3)
{
  mux_2_1_pin = (gpio_num_t)mux_1;
  gpio_set_direction(mux_2_1_pin, GPIO_MODE_OUTPUT);
  mux_2_2_pin = (gpio_num_t)mux_2;
  gpio_set_direction(mux_2_2_pin, GPIO_MODE_OUTPUT);
  mux_2_3_pin = (gpio_num_t)mux_3;
  gpio_set_direction(mux_2_3_pin, GPIO_MODE_OUTPUT);
}
...
{
    mux_1_sel_pin = (gpio_num_t)mux_pin;
}

void Tlc5940::setMux2(int mux_pin)
{
    mux_2_sel_pin = (gpio_num_t)mux_pin;
}
