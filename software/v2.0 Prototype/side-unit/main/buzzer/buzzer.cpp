...
void play_nav_sound(button_event_t button) {
  buzzer_enqueue_note(button == BUTTON_B_PRESS ? NOTE_B : NOTE_A, 4, 100, nullptr);
}

void play_enter_sound(button_event_t button) {
  buzzer_enqueue_note(button == BUTTON_B_HOLD ? NOTE_B : NOTE_A, 5, 200, nullptr);
}
